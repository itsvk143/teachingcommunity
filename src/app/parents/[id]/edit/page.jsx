...
import { Briefcase, User, MapPin, Users, Save, X, Pencil, Home } from 'lucide-react';
import { indianCities } from '@/lib/indianCities';

export default function EditParentProfile({ params: paramsPromise }) {
  ...
  const fetchProfile = async () => {
    try {
      ...
      if (res.ok) {
        ...
        // Ensure defaults if fields missing in old data
        setForm({
          ...data,
      ...
      <div className="max-w-3xl w-full bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-red-600 px-8 py-6 text-white">
          <h2 className="text-3xl font-bold mb-2 flex items-center gap-3">
            <Pencil className="w-8 h-8 opacity-80" /> Edit Profile
          </h2>
          <p className="text-orange-100 opacity-90">Update your information and preferences.</p>
        </div>
