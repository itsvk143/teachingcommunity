  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 py-12">
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Edit Student Profile</h2>
        <p className="text-gray-500 mb-8">Update your profile details.</p>
      ...
      <h3 className="text-xl font-semibold text-gray-800 mb-4">Personal Details (Optional)</h3>
