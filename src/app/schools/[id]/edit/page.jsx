...
import {
  ...
  Users, BookOpen, Trophy, School, Loader2
} from 'lucide-react';
...
const FormField = ({ label, name, type = "text", value, onChange, required = false, placeholder = "", options = null, rows = null, maxLength = null, className = "", icon: Icon, disabled = false, readOnly = false }) => {
  const baseInputClasses = `w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-gray-700 placeholder-gray-400 disabled:bg-gray-50 disabled:text-gray-500 ${readOnly ? 'bg-gray-100 cursor-not-allowed' : 'bg-white'}`;
    ...
    <div className="min-h-screen bg-gray-50/50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Edit School Profile</h1>
          ...
          <form onSubmit={handleSubmit} className="p-8">
            ...
            {step === 1 && (
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <FormField label="Email Address" name="email" type="email" value={form.email} onChange={handleChange} required icon={Mail} readOnly />
                  ...
                  <div className="md:col-span-2">
                    <FormField label="Website URL" name="website_url" type="url" value={form.website_url} onChange={handleChange} icon={Globe} />
                  </div>
                </div>
            ...
            {step === 2 && (
              <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField label="Class Range" name="class_range" value={form.class_range} onChange={handleChange} icon={BookOpen} />
                  </div>
                  ...
                  <div className="pt-6 border-t border-gray-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="md:col-span-2">
                        <FormField label="Admission Process" name="admission_process" value={form.admission_process} onChange={handleChange} rows={3} />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {step === 3 && (
              <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div>
                  <FormField label="About School (Long Description)" name="description_long" value={form.description_long} onChange={handleChange} rows={5} />
                </div>
              </div>
            )}
