...
export default function SchoolsClient({ initialSchools }) {
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filtered.slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE).map((school) => (
            ...
            {filtered.length > ITEMS_PER_PAGE && (
              <div className="flex justify-center items-center gap-4 mt-8 bg-white px-6 py-4 rounded-xl shadow-sm border border-gray-100 max-w-md mx-auto">
                <button
