...
export default async function CoachingDetailPage(props) {
  ...
  const isCoachingOwner = session?.user?.role === 'coaching';
  const isSchoolOwner = session?.user?.role === 'school';
  const canEdit = isOwner || isAdmin;
  const canViewContact = isAdmin || isOwner || isHR || isCoachingOwner || isSchoolOwner;
  ...
  const renderContactCard = (className = "") => (
    <div className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 ${className}`}>
      ...
      <div className="space-y-4">
        ...
        {coaching.whatsapp_number && (coaching.contact_visibility !== 'hr_only' || canViewContact) && (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3 space-y-6">
            ...
            {/* Contact Card */}
            {renderContactCard("hidden lg:block sticky top-6")}
