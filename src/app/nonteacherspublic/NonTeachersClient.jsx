...
export default function NonTeachersClient({ initialStaff }) {
          ...
          >
            {filteredStaff.length > 0 ? (
              <div className="flex flex-col h-full">
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {filteredStaff.slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE).map((staff) => (
                        <motion.tr
                          key={staff._id}
                ...
                {/* Pagination UI */}
                {Math.ceil(filteredStaff.length / ITEMS_PER_PAGE) > 1 && (
                  <div className="px-6 py-4 flex items-center justify-between border-t border-gray-200 bg-gray-50/50">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        onClick={() => setCurrentPage(prev => Math.min(prev + 1, Math.ceil(filteredStaff.length / ITEMS_PER_PAGE)))}
